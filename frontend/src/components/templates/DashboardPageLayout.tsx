  ...
  return (
    <DashboardShell>
      ...
      <SignedIn>
        ...
        <main
          ref={mainRef}
          className={cn("flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-950", mainClassName)}
        >
          <div
            className={cn(
            ...
            <div className="px-4 py-4 md:px-8 md:py-6">
              {headerActions ? (
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <h1 className="font-heading text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">
                      {title}
                    </h1>
                    {description ? (
